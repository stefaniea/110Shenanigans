...
public class for_loop_visualizer extends PApplet {
...
public void outer(float val) {
  resetAnimation();
  outer = (int) val;
}

public void inner(float val) {
  resetAnimation();
  inner = (int) val;
}
...
class Background {
 ...
 if(timer == 0 && outercount == 0 && innercount == 0) {  
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "for_loop_visualizer" };
    if (passedArgs != null) {
